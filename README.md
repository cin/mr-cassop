...
- [Development](docs/docs/development.md) (includes the [repeatable local install/upgrade-testing skill](docs/docs/development.md#repeatable-local-install--upgrade-testing))
