...
func setupRoutes(router *httprouter.Router, prober *Prober) {
	...
	router.GET("/nodes", prober.BasicAuth(prometheusMiddleware(prober.getNodes)))
	router.GET("/tools", prober.BasicAuth(prometheusMiddleware(prober.getTools)))
	router.GET("/stats", prober.BasicAuth(prometheusMiddleware(prober.getStat)))
	router.GET("/tables", prober.BasicAuth(prometheusMiddleware(prober.getTables)))
	router.PUT("/settings", prober.BasicAuth(prometheusMiddleware(prober.putSettings)))
